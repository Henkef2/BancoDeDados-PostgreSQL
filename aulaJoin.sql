...
SELECT banco_numero, agencia_numero, conta_corrente_numero, conta_corrente_digito, cliente_numero FROM cliente_transacoes;
...
FROM banco
JOIN agencia ON agencia.banco_numero = banco.numero;  -- 296 registros porem mostra todos os registros

SELECT count(banco.numero)
FROM banco
JOIN agencia ON agencia.banco_numero = banco.numero;  --296 registros, mostra somente o somatorio
